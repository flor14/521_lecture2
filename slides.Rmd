...
```{r clone, fig.align='center', echo = FALSE,out.width=500} 
...
* When you clone a repository your a downloading a functional git repo and the project history
...
**Git can automatically merge these and will do so when you pull**

2. Changes to a document where the same line(s) are modified 
**Git CANNOT automatically merge these**
**MERGE CONFLICT**
...
```{r mc, fig.align='center', echo = FALSE,out.width=300} 
knitr::include_graphics("img/mc_gitpush.png")
```

> What happens if I try to pull?

The problem could be solved ... or you can have a merge conflict!

---

## VS Code to solve merge conflicts

```{r mcvs, fig.align='center', echo = FALSE,out.width=300} 
